...
ALLOWED_HOSTS = ['54.225.20.174', 'localhost', '127.0.0.1']
...
# Remove in production .. for local development disable cors
...
print(os.path.join(BASE_DIR, 'frontend/public/assets'))
STATICFILES_DIRS = (
...
EMAIL_PORT=587
EMAIL_HOST_USER='lifepadorg@gmail.com'
EMAIL_HOST_PASSWORD='lifepadpassword'